...
DRILL_LENGTH = 100
FLUTE_TWIST_COUNT = 4
FLUTE_WIDTH_RATIO = 1.5  # Aumentado para una hélice más ancha
FLUTE_DEPTH_RATIO = 0.5  # Aumentado para una hélice más profunda
FLUTE_COUNT = 2
...
def create_drill_bit():
    ...
    # 1. Crear el cuerpo cilíndrico de la broca (el núcleo)
